                                      ...
                                      if (imagePath != null) {
                                        ...
                                        await SharePlus.instance.share(
                                            ShareParams(
                                              files: [XFile(path)],
                                              title:global.appName,
                                              text: "Check out the ${global.getSystemFlagValue(global.systemFlagNameList.appName)} marriage compatibility report for ${kundliMatchingController.cBoysName.text} and ${kundliMatchingController.cGirlName.text}. Get your free Matchnaking report here: $appShareLink"
                                            ))
                                            .then((value) {})
                                            .catchError((e) {
                                          // ignore: avoid_print
