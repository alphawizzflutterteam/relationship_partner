            ...
            return WillPopScope(
              ...
              child: Scaffold(
                appBar: homeController.isSelectedBottomIcon == 2
                    ...
                    : MyCustomAppBar(
                        height: 80,
                        title: Text(global.getSystemFlagValue(
                        ...
                        actions: [
                          homeController.isSelectedBottomIcon == 1
                                                                ...
                                                                child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      GetBuilder<
                                                                        ...
                                                                        return Wrap(
                                                                            children:
                                                                                List.generate(homeController.lan.length, (index) {
                                                                          return InkWell(
                                                                            onTap:
                                                                                () {
                                                                            ...
                                                                            child:
                                                                                GetBuilder<HomeController>(builder: (h) {
                                                                              return Container(
                                                                                height: 80,
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            global.spLanguage!.setString('currentLanguage',
                                                                                splashController.currentLanguageCode);
                              ...
                              : const SizedBox() /*GetBuilder<EditProfileController>(
                                  builder: (editProfileController) {
                                    return homeController
                                                .isSelectedBottomIcon ==
                                            4
                                        ? IconButton(
                                            onPressed: () {
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: Container(
                                  ...
                                  child: TabBar(
                                    controller:
                                        homeController.homeTabController,
                                    onTap: (index) async {
                                      homeController
                                        ...
                                        return chatController.chatList.isEmpty
                                            ? Column(
                                                ...
                                                children: [
                                                  ...
                                                  Center(
                                                    child: const Text(
                                                            'You don\'t have chat request yet!')
                                                        .translate(),
                                                  ),
                                                ],
                                              )
                                                          ...
                                                          children: [
                                                            Expanded(
                                                              ...
                                                              child:
                                                                  CachedNetworkImage(
                                                                imageUrl:
                                                                    '${global.imgBaseurl}${chatController.chatList[index].profile}',
                                                                imageBuilder:
                                                                    (context,
                                                                            imageProvider) =>
                                                                        Container(
                                                                    ...
                                                                    Row(
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            chatController.chatList[index].name == "" || chatController.chatList[index].name == null
                                                                                ? "User"
                                                                ...
                                                                children: [
                                                                  SizedBox(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child: splashController.currentLanguageCode ==
                                                                              'en'
                                                                          ? const Text(
                                                                              "Accept",
                                                          ...
                                                          children: [
                                                            Expanded(
                                                              ...
                                                              child:
                                                                  CachedNetworkImage(
                                                                imageUrl:
                                                                    '${global.imgBaseurl}${callController.callList[index].profile}',
                                                                imageBuilder:
                                                                    (context,
                                                                            imageProvider) =>
                                                                        Container(
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        await callController
                                                                          ...
                                                                          callController
                                                                              .callList[index]
                                                                              .callId,
                                                                          callController.callList[index].profile == ""
                                                                              ? "assets/images/no_customer_image.png"
                                                                              : callController.callList[index].profile,
                                                                          callController
                                                                              .callList[index]
                                                          ...
                                                          itemBuilder:
                                                            ...
                                                            return Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onTap: () {
                                                                  print(
                                                                      'if live chat then chatId - ${signupController.astrologerList[0].callHistory![index].chatId}');
                                                                  Get.to(() =>
                                                                      CallDetailScreen(
                                                                        callHistorydata: signupController
                                                                            .astrologerList[0]
                                                                            .callHistory![index],
                                                                      ));
                                                                },
                                                                child: Column(
                                                                  children: [
                                                                    ...
                                                                    signupController.isMoreDataAvailable ==
                                                                            ...
                                                                            !signupController
                                                                                .isAllDataLoaded &&
                                                                            signupController.astrologerList[0].callHistory!.length - 1 ==
                                                                                index
                                                                        ? const CircularProgressIndicator()
                                                                        : const SizedBox(),
                                                                    index ==
                                                                            signupController.astrologerList[0].callHistory!.length -
                                                                                1
                                                                        ? const SizedBox(
                                                                            height:
                                                                                20,
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    ...
                                                                    signupController.isMoreDataAvailable ==
                                                                            ...
                                                                            !signupController
                                                                                .isAllDataLoaded &&
                                                                            signupController.astrologerList[0].chatHistory!.length - 1 ==
                                                                                index
                                                                        ? const CircularProgressIndicator()
                                                                        : const SizedBox(),
                                                                    index ==
                                                                            signupController.astrologerList[0].chatHistory!.length -
                                                                                1
                                                                        ? const SizedBox(
                                                                            height:
                                                                                20,
                          ...
                          children: [
                            Icon(
                              homeController.isSelectedBottomIcon != 1
                                  ...
                                  : Icons.house,
                              size: 30,
                              color: homeController.isSelectedBottomIcon != 1
                                  ? Colors.grey
                                  : COLORS().primaryColor,
                            ),
                            Text("Home",
                          ...
                          children: [
                            Icon(
                              homeController.isSelectedBottomIcon != 2
                                  ...
                                  : Icons.album,
                              size: 30,
                              color: homeController.isSelectedBottomIcon != 2
                                  ? Colors.grey
                                  : Colors.black,
                            ),
                            Text("Live",
                          ...
                          children: [
                            Icon(
                              homeController.isSelectedBottomIcon != 3
                                  ...
                                  : Icons.description,
                              size: 30,
                              color: homeController.isSelectedBottomIcon != 3
                                  ? Colors.grey
                                  : COLORS().primaryColor,
                            ),
                            Text("History",
                          ...
                          children: [
                            Icon(
                              homeController.isSelectedBottomIcon != 4
                                  ...
                                  : Icons.person,
                              size: 30,
                              color: homeController.isSelectedBottomIcon != 4
                                  ? Colors.grey
                                  : COLORS().primaryColor,
                            ),
                            Text("Profile",
